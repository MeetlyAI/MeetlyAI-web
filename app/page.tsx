...
export default function Home() {
  ...
  return (
    <main className="bg-[#F3F3F3] h-full">
      ...
      <NavbarDemo/>
<button className="px-12 py-4 rounded-full bg-white font-bold text-white tracking-widest uppercase transform hover:scale-105 hover:bg-black transition-colors duration-200 m-4">
  Login
</button>
      </div>
