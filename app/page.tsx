...
export default function Home() {
 ...
 const goToHome = () => {
  ...
  return (
    <main className="bg-[#F3F3F3] h-full">
      <div className="flex justify-between items-center">
             <div className='flex items-end gap-1 m-4'>
            <h1 style={logoStyle} >Meetly</h1>
            <h1>beta</h1>
        </div>
...
<div className="hidden md:block">
<button  onClick={goToHome}  className="px-12 py-4 rounded-full bg-black font-bold text-white tracking-widest uppercase transform hover:scale-105 hover:bg-black transition-colors duration-200 m-4">
  Login
</button>
</div>
      </div>
                ...
                <div>
                    <h1 className="text-4xl font-bold text-black sm:text-6xl lg:text-7xl">
                        ...
                        <div className="relative inline-flex">
                            ...
                            <h1 className="relative text-4xl font-bold text-black sm:text-6xl lg:text-7xl">Insights.</h1>
                        </div>
                    </h1>

                    <p className="mt-8 text-base text-black sm:text-xl">Meetly uses AI to summarize video calls, helping professionals quickly capture key points and improve productivity without rewatching meetings.</p>

                    <div className="mt-10 sm:flex sm:items-center sm:space-x-8">

      <button onClick={goToHome} className="px-8 py-2  bg-black text-white text-sm rounded-full font-semibold hover:bg-black/[0.8] hover:shadow-lg">
        Try Now
      </button>
    ...
    <WobbleCardDemo/>
    <FeaturesSectionDemo/>
    <section className="py-10 bg-[#F3F3F3] sm:py-16 lg:py-24">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
